            ...
            var booksAuthors = new List<BookAuthor>()
            {
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        {
                            new Review { Headline = "Awesome Book", Text = "Reviewing Call of the Wild and it is awesome beyond words", Rating = 5,
                             Reviewer = new Reviewer(){ FirstName = "John", LastName = "Smith" } },
                            new Review { Headline = "Terrible Book", Text = "Reviewing Call of the Wild and it is terrrible book", Rating = 1,
                             Reviewer = new Reviewer(){ FirstName = "Peter", LastName = "Griffin" } },
                            new Review { Headline = "Decent Book", Text = "Not a bad read, I kind of liked it", Rating = 3,
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review { Headline = "Awesome Western Book", Text = "Reviewing Winnetou and it is awesome book", Rating = 4,
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review { Headline = "Awesome Programming Book", Text = "Reviewing Pavols Best Book and it is awesome beyond words", Rating = 5,
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review { Headline = "Good Romantic Book", Text = "This book made me cry a few times", Rating = 5,
                             Reviewer = new Reviewer(){ FirstName = "Allison", LastName = "Kutz" } },
                            new Review { Headline = "Horrible Romantic Book", Text = "My wife made me read it and I hated it", Rating = 1,
